...
set CLASSPATH=%APP_HOME%\lib\asciidoctorj-2.5.10-bin.jar;%APP_HOME%\lib\asciidoctorj-2.5.10.jar;%APP_HOME%\lib\asciidoctorj-api-2.5.10.jar;%APP_HOME%\lib\asciidoctorj-epub3-1.5.1.jar;%APP_HOME%\lib\asciidoctorj-diagram-2.2.7.jar;%APP_HOME%\lib\asciidoctorj-diagram-ditaamini-1.0.3.jar;%APP_HOME%\lib\asciidoctorj-diagram-plantuml-1.2023.5.jar;%APP_HOME%\lib\asciidoctorj-pdf-1.6.2.jar;%APP_HOME%\lib\asciidoctorj-revealjs-4.1.0.jar;%APP_HOME%\lib\jruby-complete-9.4.2.0.jar;%APP_HOME%\lib\jcommander-1.82.jar
